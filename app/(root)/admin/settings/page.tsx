...
import { Globe, DollarSign, Truck, Users, Bell } from "lucide-react";
import {
  createSettings,
...
export default function PlatformSettingsPage() {
  ...
  const saveSettings = async () => {
    try {
      // createSettings expects CreateSettingDto - map from SystemSettings
      const payload: CreateSettingDto = {
        id: settings.id,
        userId: settings.userId,
        taxRules: settings.taxRules,
        deliveryZones: settings.deliveryZones,
        deliveryZone: settings.deliveryZones,
      ...
      await updateTaxSettings({
        userId: settings.userId,
        taxRule: settings.taxRules,
      });
      await updateDeliveryZones({
        userId: settings.userId,
        deliveryZone: settings.deliveryZones,
      });
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Basic platform configuration and localization settings
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Tax rates, currency, and payment gateways
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("currencySettings", {
                    ...settings.currencySettings,
                    primaryCurrency: e.target
                      .value as CurrencySettings["primaryCurrency"],
                  })
                }
                className="mt-2"
              />
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("currencySettings", {
                    ...settings.currencySettings,
                    secondaryCurrency: e.target.value || null,
                  })
                }
                className="mt-2"
              />
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div>
              <div className="font-medium">
                {settings.deliveryZones.zoneName}
              </div>
              <div className="text-sm text-muted-foreground">
                Fee: {settings.deliveryZones.deliveryFee} ETB •{" "}
                {settings.deliveryZones.estimatedDeliveryDays} days
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {Object.entries(settings.userPermissions.permissions).map(
            ([perm, value]) => (
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleChange("userPermissions", {
                      ...
                      permissions: {
                        ...settings.userPermissions.permissions,
                        [perm]: checked,
                      },
                    })
                  }
