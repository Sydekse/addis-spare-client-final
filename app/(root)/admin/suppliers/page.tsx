...
export default function Page() {
  type Supplier = (typeof mockPendingSuppliers)[number];

  const [suppliers, setSuppliers] = useState<Supplier[]>(mockPendingSuppliers);
  const [selectedSupplier, setSelectedSupplier] = useState<Supplier | null>(
    null
  );
  const [rejectionReason, setRejectionReason] = useState("");
  const [showRejectionDialog, setShowRejectionDialog] = useState(false);
  const [supplierToReject, setSupplierToReject] = useState<Supplier | null>(
    null
  );
  ...
  const initiateRejection = (supplier: Supplier) => {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {supplierToReject?.businessDetails.businessName}
